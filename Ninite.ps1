...
$tooltip.SetToolTip($CheckBoxadoptjavax82,"64-bit Java Development Kit 8")
$tooltip.SetToolTip($CheckBoxadoptjava82,"Java Development Kit 8")
$tooltip.SetToolTip($CheckBoxadoptjavax112,"64-bit Java Development Kit 11")
